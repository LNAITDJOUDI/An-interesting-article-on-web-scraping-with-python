...
dico = {
    ...
    **{str(annee) + " (nbre de creations)": '' for annee in range(2005,2018)},
    **{str(annee) + " (nbre d'entreprises)": '' for annee in range(2005,2018)}}
...
if os.path.isfile("C:/Users/lamine/PycharmProjects/dashboard1/dataset/entreprises.csv"):
    tableauEntreprises = pd.read_csv('C:/Users/lamine/PycharmProjects/dashboard1/dataset/entreprises.csv', error_bad_lines=False, dtype='unicode')
    ...
    tableauEntreprises.to_csv('C:/Users/lamine/PycharmProjects/dashboard1/dataset/entreprises.csv', index=False)
...
def parse(lien):
    ...
    if req.status_code == 200:
        with open('C:/Users/lamine/PycharmProjects/dashboard1/dataset/entreprises.csv', 'a', encoding='utf-8') as csvfile:
