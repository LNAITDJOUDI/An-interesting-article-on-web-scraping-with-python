...
if os.path.isfile("C:/Users/lamine/PycharmProjects/dashboard1/dataset/salaires.csv"):
    tableauSalaires = pd.read_csv('C:/Users/lamine/PycharmProjects/dashboard1/dataset/salaires.csv', error_bad_lines=False, dtype='unicode',encoding = "ISO-8859-1")
    ...
    tableauSalaires.to_csv('C:/Users/lamine/PycharmProjects/dashboard1/dataset/salaires.csv', index=False,encoding = "ISO-8859-1")
...
def parse(lien):
    ...
    if req.status_code == 200:
        with open('C:/Users/lamine/PycharmProjects/dashboard1/dataset/salaires.csv', 'a', encoding='utf-8') as csvfile:
