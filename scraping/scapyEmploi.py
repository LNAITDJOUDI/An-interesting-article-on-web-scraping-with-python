...
if os.path.isfile("C:/Users/lamine/PycharmProjects/dashboard1/dataset/emploi.csv"):
    tableauEmploi = pd.read_csv('C:/Users/lamine/PycharmProjects/dashboard1/dataset/emploi.csv', error_bad_lines=False, dtype='unicode',encoding = "ISO-8859-1")
    ...
    tableauEmploi.to_csv('C:/Users/lamine/PycharmProjects/dashboard1/dataset/emploi.csv', index=False,encoding = "ISO-8859-1")
...
def parse(lien):
    ...
    if req.status_code == 200:
        with open('C:/Users/lamine/PycharmProjects/dashboard1/dataset/emploi.csv', 'a',encoding = "utf-8") as csvfile:
            writer = csv.DictWriter(csvfile, fieldnames= listCle, lineterminator='\n')
            contenu = req.content
